...
const settingUpdaters: {
  ...
  // NOTE: Phase 1/2 post-processing settings (remove_fillers_enabled,
  // auto_punctuation_enabled, itn_enabled, etc.) are intentionally omitted
  // here until bindings.ts is regenerated by `bun run tauri dev` on Windows.
  // Once regenerated, add them back with their typed command calls.
};
